...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/user/styletemplateuser.css') }}"> <!-- Link ke file CSS -->
</head>
    ...
    <div class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a style="color: rgba(150, 234, 211, 1);" class="nav-link active" class="nav-link" href="{{ url('/user/template') }}">Pesan Sekarang</a>
                </li>
                <li class="nav-item">
