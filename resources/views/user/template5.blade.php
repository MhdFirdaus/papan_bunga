    ...
    <main class="containerr">
        <section class="main-content">
            ...
            <div class="product-card">
                <img src="/images/paketE.png" alt="Papan Bunga">
                <h3>Paket E</h3>
            ...
            <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" class="rental-form" novalidate>
                @csrf
                <input type="hidden" id="jenis-paket" name="jenis_paket" value="Paket E">
                <input type="hidden" id="total_pembayaran" name="total_pembayaran" value="">
                <input type="hidden" id="gambar-paket" name="gambar_paket" value="/images/paketE.png">
