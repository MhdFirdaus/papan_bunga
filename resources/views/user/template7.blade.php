    ...
    <main class="containerr">
        <section class="main-content">
            ...
            <div class="product-card">
                <img src="/images/paketG.png" alt="Papan Bunga">
                <h3>Paket G</h3>
            ...
            <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" class="rental-form" novalidate>
                @csrf
                <input type="hidden" id="jenis-paket" name="jenis_paket" value="Paket G">
                <input type="hidden" id="total_pembayaran" name="total_pembayaran" value="">
                <input type="hidden" id="gambar-paket" name="gambar_paket" value="/images/paketG.png">
        ...
        <div class="description-box">
            <h7>Deskripsi</h7>
            <p>Paket ini menggunakan 1 buah papan jenis HPL bundar besar berukuran 1 meter.</p>
            <h7>Catatan!</h7>
        ...
        <section class="product-gallery">
            ...
            <div class="gallery">
                ...
                <div class="gallery-item">
                    <a href="{{ url('/user/template2') }}">
                        <img src="/images/paketB.png" alt="Papan Bunga 2">
                        <p>Rp. 200.000</p>
                    </a>
                </div>
                <div class="gallery-item">
                    <a href="{{ url('/user/template3') }}">
                        <img src="/images/paketC.png" alt="Papan Bunga 3">
                        <p>Rp. 230.000</p>
                    </a>
                </div>
                <div class="gallery-item">
                    <a href="{{ url('/user/template4') }}">
                        <img src="/images/paketD.png" alt="Papan Bunga 4">
                        <p>Rp. 400.000</p>
                    </a>
                </div>
                <div class="gallery-item">
                    <a href="{{ url('/user/template5') }}">
                        <img src="/images/paketE.png" alt="Papan Bunga 5">
                        <p>Rp. 450.000</p>
                    </a>
                </div>
                <div class="gallery-item">
                    <a href="{{ url('/user/template6') }}">
                        <img src="/images/paketF.png" alt="Papan Bunga 6">
                        <p>Rp. 130.000</p>
                    </a>
                </div>
            </div>
