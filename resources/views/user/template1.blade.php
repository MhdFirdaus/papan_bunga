    ...
    <main class="containerr">
        <section class="main-content">
            ...
            <div class="product-card">
                <img src="/images/paketA.png" alt="Papan Bunga">
                <h3>Paket A</h3>
            ...
            <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" class="rental-form" novalidate>
                @csrf
                <input type="hidden" id="jenis-paket" name="jenis_paket" value="Paket A">
                <input type="hidden" id="total_pembayaran" name="total_pembayaran" value="">
                <input type="hidden" id="gambar-paket" name="gambar_paket" value="/images/paketA.png">
            ...
            <div class="gallery">
                <div class="gallery-item">
                    <a href="{{ url('/user/template2') }}">
                        <img src="/images/paketB.png" alt="Papan Bunga 1">
                        <p>Rp. 200.000</p>
                    </a>
                </div>
                <div class="gallery-item">
