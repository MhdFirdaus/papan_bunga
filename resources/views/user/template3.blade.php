    ...
    <main class="containerr">
        <section class="main-content">
            ...
            <div class="product-card">
                <img src="/images/paketC.png" alt="Papan Bunga">
                <h3>Paket C</h3>
            ...
            <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" class="rental-form" novalidate>
                @csrf
                <input type="hidden" id="jenis-paket" name="jenis_paket" value="Paket C">
                <input type="hidden" id="total_pembayaran" name="total_pembayaran" value="">
                <input type="hidden" id="gambar-paket" name="gambar_paket" value="/images/paketC.png">
        ...
        <h7>Deskripsi</h7>
        <p>Paket ini menggunakan 1 buah papan berjenis HPL berbentuk persegi panjang.</p>
        <h7>Catatan!</h7>
